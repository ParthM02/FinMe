export default async function handler(req, res) {
  ...
  try {
    const response = await fetch(
      `https://api.nasdaq.com/api/quote/${symbol}/option-chain?assetclass=stocks&limit=600&fromdate=all&todate=undefined&excode=oprac&callput=callput&money=at&type=all`,
      {
        headers: {
          "User-Agent":
